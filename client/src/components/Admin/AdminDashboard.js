...
const AdminDashboard = ({ user, onLogout }) => {
  ...
  const [stats, setStats] = useState({
    users: { total: 0, customers: 0, admins: 0, recent: 0 },
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          >
            ...
            <div className="ml-3 text-left">
              ...
              <p className="text-sm text-gray-500">Configure categories and options</p>
            </div>
          </button>
        </div>
      </div>
            ...
            <div className="flex items-center">
              <Link to="/" className="flex items-center space-x-2">
                <div className="w-8 h-8 bg-yellow-600 rounded-lg flex items-center justify-center">
                  <span className="text-white font-bold text-sm">SVJ</span>
                </div>
                <span className="text-xl font-bold text-gray-900">Sri Vasavi Jewels</span>
              </Link>
            </div>
      ...
      <div className="flex">
        ...
        <div className="flex-1">
          <div className="p-8">
            ...
            {activeTab === 'settings' && <ConfigurationManagement user={user} />}
          </div>
        </div>
      </div>
    </div>
