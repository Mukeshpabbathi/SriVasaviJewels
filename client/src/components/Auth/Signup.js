...
const Signup = ({ onSignup }) => {
  ...
  const onSubmit = async (e) => {
    ...
    try {
      ...
      const res = await axios.post(apiConfig.endpoints.auth.signup, body, config);
          ...
          <div className="space-y-4">
            <div>
              <input
                ...
                type="text"
                required
                className="relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-md focus:outline-none focus:ring-gold-500 focus:border-gold-500 sm:text-sm"
